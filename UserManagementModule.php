...
namespace ybsisgood\modules\UserManagement;
...
class UserManagementModule extends \yii\base\Module
{
	 ...
	 * @var string
	 */
	public $registrationFormClass = 'ybsisgood\modules\UserManagement\models\forms\RegistrationForm';
	...
	public $controllerNamespace = 'ybsisgood\modules\UserManagement\controllers';
	...
	public static function t($category, $message, $params = [], $language = null)
	{
		if ( !isset(Yii::$app->i18n->translations['modules/user-management/*']) )
		{
			Yii::$app->i18n->translations['modules/user-management/*'] = [
				...
				'sourceLanguage' => 'en',
				'basePath'       => '@vendor/ybsisgood/module-user-management/messages',
				'fileMap'        => [
