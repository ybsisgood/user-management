...
namespace ybsisgood\modules\UserManagement\models\search;
...
/**
 * UserVisitLogSearch represents the model behind the search form about `ybsisgood\modules\UserManagement\models\UserVisitLog`.
 */
